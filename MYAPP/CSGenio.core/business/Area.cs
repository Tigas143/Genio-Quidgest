...
namespace CSGenio.business
{
    ...
    public abstract class Area : IArea
    {
        ...
        private static AreaRef m_AreaCITY = new AreaRef("PJF", "pjfcity", "city");
        public static AreaRef AreaFLIGH { get { return m_AreaFLIGH; } }
        private static AreaRef m_AreaFLIGH = new AreaRef("PJF", "pjffligh", "fligh");
        public static AreaRef AreaS_UA { get { return m_AreaS_UA; } }
        private static AreaRef m_AreaS_UA = new AreaRef("PJF", "userauthorization", "s_ua");
        public static AreaRef AreaAPSW { get { return m_AreaAPSW; } }
        private static AreaRef m_AreaAPSW = new AreaRef("PJF", "pjfapsw", "apsw");
        public static AreaRef AreaAIRHB { get { return m_AreaAIRHB; } }
        private static AreaRef m_AreaAIRHB = new AreaRef("PJF", "pjfairpt", "airhb");
        public static AreaRef AreaCREW { get { return m_AreaCREW; } }
        private static AreaRef m_AreaCREW = new AreaRef("PJF", "pjfcrew", "crew");
        public static AreaRef AreaS_NM { get { return m_AreaS_NM; } }
        private static AreaRef m_AreaS_NM = new AreaRef("PJF", "notificationmessage", "s_nm");
        public static AreaRef AreaAIRSC { get { return m_AreaAIRSC; } }
        private static AreaRef m_AreaAIRSC = new AreaRef("PJF", "pjfairpt", "airsc");
        public static AreaRef AreaAIRCR { get { return m_AreaAIRCR; } }
        private static AreaRef m_AreaAIRCR = new AreaRef("PJF", "pjfairpt", "aircr");
        public static AreaRef AreaMATE { get { return m_AreaMATE; } }
        private static AreaRef m_AreaMATE = new AreaRef("PJF", "pjfmate", "mate");
        public static AreaRef AreaMEM { get { return m_AreaMEM; } }
        private static AreaRef m_AreaMEM = new AreaRef("PJF", "pjfmem", "mem");
        public static AreaRef AreaS_PAX { get { return m_AreaS_PAX; } }
        private static AreaRef m_AreaS_PAX = new AreaRef("PJF", "asyncprocessattachments", "s_pax");
        public static AreaRef AreaROUTE { get { return m_AreaROUTE; } }
        private static AreaRef m_AreaROUTE = new AreaRef("PJF", "pjfroute", "route");
        public static AreaRef AreaPSW { get { return m_AreaPSW; } }
        private static AreaRef m_AreaPSW = new AreaRef("PJF", "userlogin", "psw");
        public static AreaRef AreaAIRDS { get { return m_AreaAIRDS; } }
        private static AreaRef m_AreaAIRDS = new AreaRef("PJF", "pjfairpt", "airds");
        public static AreaRef AreaS_ARG { get { return m_AreaS_ARG; } }
        private static AreaRef m_AreaS_ARG = new AreaRef("PJF", "asyncprocessargument", "s_arg");
        public static AreaRef AreaMAINT { get { return m_AreaMAINT; } }
        private static AreaRef m_AreaMAINT = new AreaRef("PJF", "pjfmaint", "maint");
        public static AreaRef AreaAIRLN { get { return m_AreaAIRLN; } }
        private static AreaRef m_AreaAIRLN = new AreaRef("PJF", "pjfairln", "airln");
        public static AreaRef AreaS_NES { get { return m_AreaS_NES; } }
        private static AreaRef m_AreaS_NES = new AreaRef("PJF", "notificationemailsignature", "s_nes");
        public static AreaRef AreaPERSO { get { return m_AreaPERSO; } }
        private static AreaRef m_AreaPERSO = new AreaRef("PJF", "pjfperso", "perso");
        public static AreaRef AreaPLANE { get { return m_AreaPLANE; } }
        private static AreaRef m_AreaPLANE = new AreaRef("PJF", "pjfplane", "plane");
        public static AreaRef AreaS_APR { get { return m_AreaS_APR; } }
        private static AreaRef m_AreaS_APR = new AreaRef("PJF", "asyncprocess", "s_apr");
        public static AreaRef AreaAIRPT { get { return m_AreaAIRPT; } }
        private static AreaRef m_AreaAIRPT = new AreaRef("PJF", "pjfairpt", "airpt");
        public static AreaRef AreaBOOKG { get { return m_AreaBOOKG; } }
        private static AreaRef m_AreaBOOKG = new AreaRef("PJF", "pjfbookg", "bookg");
        public static AreaRef AreaPILOT { get { return m_AreaPILOT; } }
        private static AreaRef m_AreaPILOT = new AreaRef("PJF", "pjfpilot", "pilot");
        //areas hardcoded
        public static AreaRef AreaDELEGA { get { return m_AreaDELEGA; } }
        private static AreaRef m_AreaDELEGA = new AreaRef("PJFdelega", "delega");
        ...
        private static AreaRef m_AreaMQQUEUES = new AreaRef("PJFmqqueues", "mqqueues");
        ...
        private static AreaRef m_AreaTBLCFG = new AreaRef("PJFtblcfg", "tblcfg");
        public static AreaRef AreaTBLCFGSEL { get { return m_AreaTBLCFGSEL; } }
        private static AreaRef m_AreaTBLCFGSEL = new AreaRef("PJFtblcfgsel", "tblcfgsel");
		//END: User table configuration
        public static AreaRef AreaLSTUSR { get { return m_AreaLSTUSR; } }
        private static AreaRef m_AreaLSTUSR = new AreaRef("PJFlstusr", "lstusr");
        public static AreaRef AreaLSTCOL { get { return m_AreaLSTCOL; } }
        private static AreaRef m_AreaLSTCOL = new AreaRef("PJFlstcol", "lstcol");
        public static AreaRef AreaUSRCFG { get { return m_AreaUSRCFG; } }
        private static AreaRef m_AreaUSRCFG = new AreaRef("PJFusrcfg", "usrcfg");
        public static AreaRef AreaLSTREN { get { return m_AreaLSTREN; } }
        private static AreaRef m_AreaLSTREN = new AreaRef("PJFlstren", "lstren");
        public static AreaRef AreaUSRWID { get { return m_AreaUSRWID; } }
        private static AreaRef m_AreaUSRWID = new AreaRef("PJFusrwid", "usrwid");
