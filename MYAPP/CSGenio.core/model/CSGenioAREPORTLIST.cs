...
namespace CSGenio.business
{
	...
	public class CSGenioAreportlist : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
            ...
            info.RegisterFieldDB(new Field("codreport", FieldType.CHAVE_PRIMARIA));  
			info.DBFields["codreport"].FieldSize = 6;			
			info.KeyType = CodeType.INT_KEY;
            info.RegisterFieldDB(new Field("report", FieldType.TEXTO));
	        info.RegisterFieldDB(new Field("slotid", FieldType.TEXTO));
			info.RegisterFieldDB(new Field("titulo", FieldType.TEXTO));
		...
		// USE /[MANUAL PJF TABAUX reportlist]/
