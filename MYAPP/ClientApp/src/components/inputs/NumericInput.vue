...
<script>
	...
	/**
	 * The component is mandatory for this control and
	 * 	is dynamically called by "wrapperComponent", without which some tests do not function.
	 */
	...
	export default {
		...
		methods: {
			...
			emitModelValue()
			{
				...
				// Convert to number
				const value = this.maxDecimals === 0 ? parseInt(strValue) : parseFloat(strValue)
