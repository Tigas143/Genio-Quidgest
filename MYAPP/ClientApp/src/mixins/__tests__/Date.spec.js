...
describe('Date', () => {
	...
	it.each([null, undefined, ''])('Empty date is correctly displayed when the value is %s', async (emptyValue) => {
	...
	it('Valid date is correctly displayed', async () => {
	...
	it('Invalid date reverts to empty default', async () => {
