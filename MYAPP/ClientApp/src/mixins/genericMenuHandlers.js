...
export default {
	...
	methods: {
		...
		setPHEValue(listCfg, actionCfg, rowData)
		{
			...
			netAPI.postData(this.controls.menu.controller, 'DefineEphForm', params, (_, request) => this.handleDefinedPHE(request, [rowData.rowKey]))
		},
		...
		setPHEValues(listCfg, actionData)
		{
			...
			netAPI.postData(this.controls.menu.controller, 'DefineEphFormValues', params, (_, request) => this.handleDefinedPHE(request, data))
		}
	},
