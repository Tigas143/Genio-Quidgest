<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-airln-airhbname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['AIRLN___AIRHBNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AirlnAirhbnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('AIRLN___AIRHBNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'AIRLN___AIRHBNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'AIRLN___AIRHBNAME_____SeeMore',
					name: 'AIRLN___AIRHBNAME_____SeeMore',
					controller: 'AIRLN',
					action: 'AIRLN_AirhbValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-airln-airhbname',
				headerTitle: computed(() => this.Resources.AIRPORT_HUBS28648),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'AIRLN___AIRHBNAME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-airln-airhbname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Airln_AirhbValName',
							serverMode: true,
							pkColumn: 'ValCodairpt',
							tableAlias: 'AIRHB',
							tableNamePlural: computed(() => this.Resources.AIRPORT_HUBS28648),
							viewManagement: '',
							showLimitsInfo: true,
							tableTitle: '',
						...
						changeEvents: ['changed-CITY', 'changed-AIRHB'],
						uuid: 'Airln_Airln_AirhbValName',
