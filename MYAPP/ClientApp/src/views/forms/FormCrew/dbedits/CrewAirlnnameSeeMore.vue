<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-crew-airlnname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CREW____AIRLNNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CrewAirlnnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CREW____AIRLNNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'CREW____AIRLNNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CREW____AIRLNNAME_____SeeMore',
					name: 'CREW____AIRLNNAME_____SeeMore',
					controller: 'CREW',
					action: 'CREW_AirlnValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'CREW____AIRLNNAME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-crew-airlnname')
		},
