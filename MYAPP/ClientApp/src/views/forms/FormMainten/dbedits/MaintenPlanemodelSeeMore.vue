<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-mainten-planemodel-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['MAINTEN_PLANEMODEL____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'MaintenPlanemodelSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('MAINTEN_PLANEMODEL____SeeMore', false),

				interfaceMetadata: {
					id: 'MAINTEN_PLANEMODEL____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'MAINTEN_PLANEMODEL____SeeMore',
					name: 'MAINTEN_PLANEMODEL____SeeMore',
					controller: 'MAINT',
					action: 'MAINTEN_PlaneValModel'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-mainten-planemodel',
				...
				isActive: true,
				returnElement: 'MAINTEN_PLANEMODEL___'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-mainten-planemodel')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Mainten_Mainten_PlaneValModel',
