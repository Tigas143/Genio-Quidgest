<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-mateprofcrew-crewname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['MATEPROFCREW_CREWNAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'MateprofcrewCrewnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('MATEPROFCREW_CREWNAME_SeeMore', false),

				interfaceMetadata: {
					id: 'MATEPROFCREW_CREWNAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'MATEPROFCREW_CREWNAME_SeeMore',
					name: 'MATEPROFCREW_CREWNAME_SeeMore',
					controller: 'MATE',
					action: 'MATEPROF_CrewValCrewname'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-mateprofcrew-crewname',
				headerTitle: computed(() => this.Resources.CABINCREW52945),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'MATEPROFCREW_CREWNAME'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-mateprofcrew-crewname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Mateprof_Mateprof_CrewValCrewname',
