<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pilot-airlnname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PILOT___AIRLNNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PilotAirlnnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PILOT___AIRLNNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PILOT___AIRLNNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PILOT___AIRLNNAME_____SeeMore',
					name: 'PILOT___AIRLNNAME_____SeeMore',
					controller: 'PILOT',
					action: 'PILOT_AirlnValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PILOT___AIRLNNAME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pilot-airlnname')
		},
