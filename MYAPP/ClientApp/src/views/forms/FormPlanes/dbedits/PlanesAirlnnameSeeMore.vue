<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-planes-airlnname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PLANES__AIRLNNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PlanesAirlnnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PLANES__AIRLNNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PLANES__AIRLNNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PLANES__AIRLNNAME_____SeeMore',
					name: 'PLANES__AIRLNNAME_____SeeMore',
					controller: 'PLANE',
					action: 'PLANES_AirlnValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-planes-airlnname',
				headerTitle: computed(() => this.Resources.AIRLINE57868),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'PLANES__AIRLNNAME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-planes-airlnname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Planes_Planes_AirlnValName',
