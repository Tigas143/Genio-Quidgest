<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-psw-airlnname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PSW_____AIRLNNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PswAirlnnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PSW_____AIRLNNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PSW_____AIRLNNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PSW_____AIRLNNAME_____SeeMore',
					name: 'PSW_____AIRLNNAME_____SeeMore',
					controller: 'APSW',
					action: 'PSW_AirlnValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PSW_____AIRLNNAME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-psw-airlnname')
		},
