...
public class CardsControl: ControlObject
{
    ...
    private IList<IWebElement> cardList => m_control.FindElements(ByData.Testid("q-card"));
    private IWebElement insertCard => m_control.FindElement(By.CssSelector(".q-card--insert"));
    ...
    public string GetCardTitle(int index)
    {
        ...
        var title = card.FindElement(By.CssSelector(".q-card__title"));
        return title.Text;
    }
