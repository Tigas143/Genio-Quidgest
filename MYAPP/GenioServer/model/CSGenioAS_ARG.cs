...
namespace CSGenio.business
{
	...
	public class CSGenioAs_arg : DbArea	{
		...
		public CSGenioAs_arg(User user, string module)
		{
			...
			// USE /[MANUAL PJF CONSTRUTOR S_ARG]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codargpr", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("valor", FieldType.TEXTO);
			...
			Qfield.Dupmsg = "";
			info.RegisterFieldDB(Qfield);
			Qfield = new Field("documentfk", FieldType.CHAVE_ESTRANGEIRA);
			Qfield.FieldSize = 8;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("tipo", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("hidden", FieldType.LOGICO);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("s_apr", new Relation("PJF", "asyncprocessargument", "s_arg", "codargpr", "cods_apr", "PJF", "asyncprocess", "s_apr", "codascpr", "codascpr"));
		}
