...
namespace CSGenio.business
{
	...
	public class CSGenioAs_ua : DbArea	{
		...
		public CSGenioAs_ua(User user, string module)
		{
			...
			// USE /[MANUAL PJF CONSTRUTOR S_UA]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codua", FieldType.CHAVE_PRIMARIA);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("sistema", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("modulo", FieldType.ARRAY_COD_TEXTO);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("psw", new Relation("PJF", "userauthorization", "s_ua", "codua", "codpsw", "PJF", "userlogin", "psw", "codpsw", "codpsw"));
		}
