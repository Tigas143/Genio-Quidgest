...
namespace Administration
{
    ...
    public class UserManagement : IUserManagementService
    {
        ...
        public List<ModulesLevel> GetPermissions()
        {
            ...
            perm.Add(new ModulesLevel("PJF", Resources.Resources.AIRLINES_MANAGER26919, "10", Resources.Resources.STAFF42088));
            perm.Add(new ModulesLevel("PJF", Resources.Resources.AIRLINES_MANAGER26919, "90", Resources.Resources.AIRLINE57868));
            perm.Add(new ModulesLevel("PJF", Resources.Resources.AIRLINES_MANAGER26919, "99", Resources.Resources.ADMINISTRADOR57294));
        ...
        public bool CreateUserWithPassAndLevels(string username, string password, List<ModulesLevel> levels)
        {
            ...
            try
            {
                ...
                CSGenioApsw userPsw = new CSGenioApsw(user, "PJF");
