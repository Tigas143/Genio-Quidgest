...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// Application version
        /// </summary>
        public static int Version { get; } = 2669;

        /// <summary>
        /// System id
        /// </summary>
        public static string Program { get; } = "PJF";
        ...
        /// </summary>
        public const int VersionDbGen = 2669;

        /// <summary>
        /// Version of the database indexes
        /// </summary>
        public const int VersionIdxDbGen = 169;
        ...
        /// </summary>
        public const string GenioVersion = "346.60";

        /// <summary>
        /// Solution build version
        /// </summary>
        public const int BuildVersionGen = 144;
        /// <summary>
        ...
        {
			// USE /[MANUAL PJF RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
