...
namespace CSGenio.business
{
	...
	public class CSGenioAnotificationmessage : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
            ...
            info.RegisterFieldDB(new Field("codmesgs", FieldType.CHAVE_PRIMARIA));
            info.DBFields["codmesgs"].FieldSize = 6;
            info.RegisterFieldDB(new Field("codsigna", FieldType.CHAVE_ESTRANGEIRA));
            info.DBFields["codsigna"].FieldSize = 6;
            info.RegisterFieldDB(new Field("codpmail", FieldType.CHAVE_ESTRANGEIRA));
            info.DBFields["codpmail"].FieldSize = 6;
            info.RegisterFieldDB(new Field("codtpnot", FieldType.CHAVE_ESTRANGEIRA));
            info.DBFields["codtpnot"].FieldSize = 6;
            info.RegisterFieldDB(new Field("coddestn", FieldType.CHAVE_ESTRANGEIRA));
            info.DBFields["coddestn"].FieldSize = 6;
		...
		// USE /[MANUAL PJF TABAUX notificationmessage]/
