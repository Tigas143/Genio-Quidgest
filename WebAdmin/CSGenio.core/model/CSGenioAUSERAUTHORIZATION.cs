...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("PJF", "userauthorization", "userauthorization", "codua", "codpsw", "$mae.TabelaDestino.TabelaDominio.Schema.ToUpper()", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL PJF TABAUX UserAuthorization]/
