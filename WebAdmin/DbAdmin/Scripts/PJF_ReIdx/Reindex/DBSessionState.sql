...
SET @SQL = N'
CREATE DATABASE [ASPStatePJF]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStatePJF'', FILENAME = N''' + @SQLDataFolder + 'ASPStatePJF.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStatePJF_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStatePJF_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePJF_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStatePJF_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePJF_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStatePJF] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStatePJF] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
